--MO_HA_ _IN0239KKT_20160630_HarshadaMundye
--MO_HA_ _IN0239Wheel_20160630_HarshadaMundye
...
on a.mobileprefix = b.mobileprefix
where a.optinhulbrand in ('A','C') and a.ismobilevalid = 'Y' and lower(a.brand) like '%wheel%'
and (lower(b.region) like '%madhya%' )	
